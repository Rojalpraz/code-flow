        ...
        <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-white">CodeFlow</h3>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Features</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Roadmap</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Changelog</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Careers</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Press</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Partners</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Documentation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Help Center</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Community</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">API Reference</a></li>
              <li><a href="#" className="text-gray-400 hover:text-sky-500 text-sm transition-colors">Status</a></li>
            </ul>
          </div>
